  ...
  return (
    ...
    >
      ...
      <div className="flex justify-evenly gap-8 flex-wrap">
        ...
        <a
          className=""
          href="https://www.linkedin.com/in/romeo-froger-40570b190/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a className="" href="mailto:romeo.froger@gmail.com">
          <h2 className="flex items-center gap-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
            ...
            romeo.froger@gmail.com
          </h2>
        </a>
        <a className="" href="https://github.com/RomeoFroger49">
          <h2 className="flex items-center gap-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
        ...
        <a className="" href="tel:0785737550">
          <h2 className="flex items-center gap-1">
            <CallIcon />
            07 85 73 75 50
          </h2>
