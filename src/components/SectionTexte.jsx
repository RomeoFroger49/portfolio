  ...
  return (
    ...
    >
      <p
        ...
        ref={sectionRef}
      >
        <i id="i-section">Roméo Froger</i>, software engineering student with a
        background in full-stack development, now focused on{" "}
        <i id="i-section">artificial intelligence</i> and the engineering of
