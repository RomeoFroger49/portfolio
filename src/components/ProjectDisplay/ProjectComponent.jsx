export default function ProjectComponent({ project }) {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="bg-black w-[80%] bg-primary p-1 relative group/img rounded">
        <a href={link} target="_blank" rel="noreferrer" id="img-projects">
          <img className="" src={image} alt={title} />
        </a>
        <a
          href={link}
          className="absolute top-0 left-0 w-[95%] h-[95%] bg-background opacity-90 hidden group-hover/img:flex justify-center items-center m-2"
        >
