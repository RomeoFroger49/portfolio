...
export default function Hero() {
  return (
    <section id="hero" content="hero" className="relative h-q-full">
      <div className="h-full flex flex-col items-center justify-center gap-8 xl:gap-16 relative leading-10">
        <h1 className="xl:text-8xl lg:text-4xl sm:text-2xl text-xl  font-satoshiBlack xl:pr-12 sm:pr-4 text-primary transform scale-0 animate-enter-1  text-contour">
          Hello, I'm Roméo
        </h1>
        <h1 className="xl:text-8xl lg:text-4xl sm:text-2xl  text-xl font-satoshiBlack text-text  transform scale-0 animate-enter-2   text-contour">
          Hello, I'm Roméo
        </h1>
        <h1 className="xl:text-8xl lg:text-4xl sm:text-2xl text-xl font-satoshiBlack xl:pl-12 sm:pl-4 text-primary transform scale-0 animate-enter-3  text-contour">
          Hello, I'm Roméo
        </h1>
        <svg
